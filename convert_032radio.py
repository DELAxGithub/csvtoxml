...
def process_file(csv_path, template_path, output_path):
    ...
    # Generate XML using the library directly since headers are correct
    try:
...
def main():
    base_dir = Path("032radio")
    
    # Mapping new CSV files to existing templates
    # 32_1.csv -> 32オリジナル_1.xml
    # 32_2.csv -> 32オリジナル_2.xml
