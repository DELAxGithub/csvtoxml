...
入力:
  木崎_whisper.csv (Speaker Name, Start Time, End Time, Text)
  朴_whisper.csv (同上)

出力:
  39_whisper_merged.csv (Speaker Name, イン点, アウト点, 文字起こし, 色選択)
    - 両ピンマイクの発話を時間順にソート
    - HALLUCINATION_FILTERED 行は除外
    - 色: 木崎=Lavender, 朴=Violet
"""
import csv
...
EPISODE = "39"
INPUTS = [
    (BASE / "木崎_whisper.csv", "木崎", "Lavender"),  # Tr1
    (BASE / "朴_whisper.csv", "朴", "Violet"),    # Tr2
]
# ===============================
