...
# ===== エピソード固有設定 =====
WAV_PATHS = {
    "土門": WAV_DIR / "260829_001_Tr1.WAV",
    "松田": WAV_DIR / "260829_001_Tr2.WAV",
}
# ===============================
...
def main():
    ...
    ap.add_argument("--speaker", required=True, choices=["土門", "松田"])
    ap.add_argument("--offset", type=int, default=0, help="先頭からスキップするVADセグメント数")
